...
static void canzero_serialize_canzero_message_guidance_board_back_stream_errors(canzero_message_guidance_board_back_stream_errors* msg, canzero_frame* frame) {
  ...
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_outer_airgap_left_invalid & (0xFF >> (8 - 1))) << 18;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_inner_airgap_left_invalid & (0xFF >> (8 - 1))) << 19;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_outer_airgap_right_invalid & (0xFF >> (8 - 1))) << 20;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_inner_airgap_right_invalid & (0xFF >> (8 - 1))) << 21;
  ((uint32_t*)data)[0] |= (uint8_t)(msg->m_error_input_current_invalid & (0xFF >> (8 - 1))) << 22;
