...
static void canzero_serialize_canzero_message_guidance_board_back_stream_errors(canzero_message_guidance_board_back_stream_errors* msg, canzero_frame* frame) {
  ...
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_outer_airgap_left_invalid & (0xFF >> (8 - 1))) << 18;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_inner_airgap_left_invalid & (0xFF >> (8 - 1))) << 19;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_outer_airgap_right_invalid & (0xFF >> (8 - 1))) << 20;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_inner_airgap_right_invalid & (0xFF >> (8 - 1))) << 21;
  ((volatile uint32_t*)data)[0] |= (uint8_t)(msg->m_error_input_current_invalid & (0xFF >> (8 - 1))) << 22;
...
static PROGMEM void canzero_handle_get_req(canzero_frame* frame) {
  ...
  case 36: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_input_current_rx_fragmentation_buffer, 7, 36, msg.m_header.m_client_id);
    break;
  }
  case 37: {
  ...
  case 42: {
    ...
    resp.m_header.m_eof = 0;
    resp.m_header.m_toggle = 0;
    schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_temperature_rx_fragmentation_buffer, 7, 42, msg.m_header.m_client_id);
    break;
  }
  case 43: {
...
void canzero_send_error_level_config_input_current() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_input_current_send_fragmentation_buffer, 7, 36, 255);
...
void canzero_send_error_level_config_magnet_temperature() {
  ...
  canzero_serialize_canzero_message_get_resp(&msg, &sender_frame);
  canzero_can0_send(&sender_frame);
  schedule_get_resp_fragmentation_job(__oe_error_level_config_magnet_temperature_send_fragmentation_buffer, 7, 42, 255);
