...
static constexpr AdcEtcBeginInfo adc_config() {
  TrigChainInfo chains[2];
  chains[0].trig_num = TRIG0;
  ain_pin chain0_pins[] = {ain_pin::disp_sense_lim_l_18,
                           ain_pin::disp_sense_lim_r_16, ain_pin::i_mag_r_25};
  ...
  ain_pin chain4_pins[] = {ain_pin::disp_sense_mag_l_19,
                           ain_pin::disp_sense_mag_r_17, ain_pin::i_mag_l_24};
